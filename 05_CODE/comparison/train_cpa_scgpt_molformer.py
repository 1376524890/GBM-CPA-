...
Usage:
  ...
  CUDA_VISIBLE_DEVICES=0 python 05_CODE/comparison/train_cpa_scgpt_molformer.py
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-dir", type=Path, default=RUNTIME / "models" / "legacy_comparison" / "GBM_CPA_scGPT_MolFormer_model")
    parser.add_argument("--predicted", type=Path, default=RUNTIME / "predictions" / "legacy_comparison" / "GBM_CPA_scGPT_MolFormer_PW034_Panobinostat_pred.h5ad")
