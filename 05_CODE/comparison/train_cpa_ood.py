...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-dir", type=Path, default=RUNTIME / "models" / "legacy_comparison" / "GBM_CPA_model")
    parser.add_argument("--predicted", type=Path, default=RUNTIME / "predictions" / "legacy_comparison" / "GBM_CPA_PW034_Panobinostat_pred.h5ad")
    parser.add_argument("--metrics-md", type=Path, default=RUNTIME / "evaluation" / "legacy_nips" / "GBM_CRISP_OOD_metrics.md")
    parser.add_argument("--training-log", type=Path, default=RUNTIME / "logs" / "GBM_CPA_training.log")
