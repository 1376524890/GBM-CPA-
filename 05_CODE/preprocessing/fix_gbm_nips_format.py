...
Usage:
  ...
  python 05_CODE/preprocessing/fix_gbm_nips_format.py
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input", type=Path, default=REUSABLE / "preprocessed_data" / "GBM_with_embeddings.h5ad")
    parser.add_argument("--output", type=Path, default=DELIVERY / "dataset" / "GBM_NIPS_Ready.h5ad")
