...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--adata", type=Path, default=Path("GBM_Universal_Perturbation_Ready.h5ad"))
    parser.add_argument("--output", type=Path, default=Path("GBM_MeanShiftBaseline_PW034_Panobinostat_pred.h5ad"))
