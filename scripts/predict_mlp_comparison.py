...
Usage:
  ...
  python scripts/predict_mlp_comparison.py --method M1
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--adata", type=Path, default=ROOT / "GBM_with_embeddings.h5ad")
    parser.add_argument("--molformer-parquet", type=Path, default=ROOT / "GBM_molformer_drug_emb.parquet")
    parser.add_argument("--output-dir", type=Path, default=ROOT / "mlp_comparison_results")
...
def main() -> None:
    ...
    adata_full_eval = ad.read_h5ad(ROOT / "GBM_Universal_Perturbation_Ready.h5ad")
