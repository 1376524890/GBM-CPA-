...
Usage:
  ...
  CUDA_VISIBLE_DEVICES=0 python scripts/train_scgpt_aligner.py
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--aligned-output", type=Path, default=ROOT / "GBM_scGPT_aligned_XscGPT.npy")
    parser.add_argument("--model-out", type=Path, default=ROOT / "GBM_scGPT_aligner.pt")
