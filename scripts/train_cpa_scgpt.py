...
Usage:
  ...
  CUDA_VISIBLE_DEVICES=0 python scripts/train_cpa_scgpt.py --scgpt-key X_scGPT --method M1
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-dir", type=Path, default=ROOT / "GBM_CPA_scGPT_model")
    parser.add_argument("--predicted", type=Path, default=ROOT / "GBM_CPA_scGPT_PW034_Panobinostat_pred.h5ad")
