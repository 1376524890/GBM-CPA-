...
def detect_h5ad_path():
    ...
    candidates = [
        "GBM_NIPS_Ready.h5ad",
        "../GBM_NIPS_Ready.h5ad",
        os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "GBM_NIPS_Ready.h5ad"),
    ]
    # Also check cwd parent
    cwd_parent = os.path.join(os.getcwd(), "GBM_NIPS_Ready.h5ad")
    candidates.append(cwd_parent)
    cwd_parent2 = os.path.join(os.path.dirname(os.getcwd()), "GBM_NIPS_Ready.h5ad")
