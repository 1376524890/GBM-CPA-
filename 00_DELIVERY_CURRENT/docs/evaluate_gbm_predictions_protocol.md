...
**版本**: v1.1 (基于 `00_DELIVERY_CURRENT/dataset/GBM_NIPS_Ready.h5ad` unified)
**最后更新**: 2026-05-19
**唯一主文件**: `00_DELIVERY_CURRENT/dataset/GBM_NIPS_Ready.h5ad`
...
**核心原则**:
- 所有方法使用同一个 `00_DELIVERY_CURRENT/dataset/GBM_NIPS_Ready.h5ad`
- 统一使用 log1p 评估空间
...
adata = ad.read_h5ad("00_DELIVERY_CURRENT/dataset/GBM_NIPS_Ready.h5ad")
...
python 00_DELIVERY_CURRENT/code/cpa_nips/reevaluate_counts_predictions_log1p.py \
    --h5ad 00_DELIVERY_CURRENT/dataset/GBM_NIPS_Ready.h5ad \
    --output-dir 00_DELIVERY_CURRENT/evaluation/unified_log1p
```
