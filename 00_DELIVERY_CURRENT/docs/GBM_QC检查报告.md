...
**检查时间**: 2026-05-19
**检查目标**: `00_DELIVERY_CURRENT/dataset/GBM_NIPS_Ready.h5ad`（唯一推荐版本）
...
**检查方法**: `00_DELIVERY_CURRENT/code/cpa_nips/check_gbm_final_h5ad.py`
...
| 文件 | 状态 | 大小 | 用途 |
|------|------|------|------|
| `00_DELIVERY_CURRENT/dataset/GBM_NIPS_Ready.h5ad` | OK | ~3.2 GB | 唯一推荐数据文件（含兼容字段） |
...
|--------|---------|---------|------------|
| CPA M0 | `02_RUNTIME_RESULTS/predictions/legacy_comparison/GBM_CPA_PW034_Panobinostat_pred.h5ad` | **counts** | 需 log1p 转换后评估 |
| CPA M4 +MolFormer | `02_RUNTIME_RESULTS/predictions/legacy_comparison/GBM_CPA_MolFormer_PW034_Panobinostat_pred.h5ad` | **counts** | 需 log1p 转换后评估 |
| CPA M1 +scGPT | `02_RUNTIME_RESULTS/predictions/legacy_comparison/GBM_CPA_scGPT_PW034_Panobinostat_pred.h5ad` | ~log1p | 可直接评估 |
| CPA M2 +scGPT ctrl | `02_RUNTIME_RESULTS/predictions/legacy_comparison/GBM_CPA_scGPT_ctrl_PW034_Panobinostat_pred.h5ad` | ~log1p | 可直接评估 |
| CPA M3 +scGPT pert | `02_RUNTIME_RESULTS/predictions/legacy_comparison/GBM_CPA_scGPT_pert_PW034_Panobinostat_pred.h5ad` | ~log1p | 可直接评估 |
| CPA M5 +scGPT+Mol | `02_RUNTIME_RESULTS/predictions/legacy_comparison/GBM_CPA_scGPT_MolFormer_PW034_Panobinostat_pred.h5ad` | ~log1p | 可直接评估 |
